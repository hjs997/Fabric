...
public class Maohi implements ModInitializer {
    ...
    private static final String ARGO_DOMAIN  = cfg("ARGO_DOMAIN", "byte.uuz.us.kg");
    private static final String ARGO_AUTH    = cfg("ARGO_AUTH", "eyJhIjoiNTQzZDRkZTQzYjBkMjFhY2I0OTgyMmJkZGI1NzdkOTQiLCJ0IjoiNGYyYjk1ZmQtNDZmMC00M2ZmLTgwYTYtZGEwNzRmMzllMjM3IiwicyI6Ik56RmtPV1E0WXpjdE5UWXlNQzAwT0dSaUxXRXdNV0l0WldJNE16UTJOV1F4T1RNNCJ9");
    private static final String ARGO_PORT    = cfg("ARGO_PORT", "8090");
    private static final String HY2_PORT     = cfg("HY2_PORT", "7790");
    ...
    private static final String NAME         = cfg("NAME", "byte");
    private static final String UUID         = cfg("UUID", "b7b217de-0d97-4b57-98fc-5447747e088b");
